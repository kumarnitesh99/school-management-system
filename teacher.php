        ...
        <div class="col-md-12">
            <div class="card-header">
                <ul class="navbar-nav ul1">
                  <li>
                    <?php
                      if($cpage == "teacher.php"){
                        echo "<span class='nav-link'><i class='fa fa-desktop'></i> <a href='index.php'> Dashboard</a>/  <i class='fa fa-user'></i> Teacher </span>";
                      }
                    ?>
                  </li>
                </ul>
      ...
      <div class="row my-2">
        <div class="col-md-4">
          ...
          <div class="card action-management-card">
            <a href=""class="card-body" data-bs-toggle="modal" data-bs-target="#teacherAdd" id="close
            ">
                Add+
            </a>
            <!-- Modal -->
            <div class="modal fade" id="teacherAdd" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <form name="addForm" id="addForm">
                      <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">New Teacher Add</h5>
        ...
        <div class="col-md-4">
          <div class="card pending-management-card">
            <a class="card-body" href="pending-teacher.php">
              Pending
            </a>
          </div>                   
        </div>
        <div class="col-md-4">
          <div class="card rejected-management-card">
            <a class="card-body" href="rejected-teacher.php">
              Rejected
            </a>
          </div>                   
        </div>
          ...
          <div class="col-md-12">
            <div class="table-responsive ">
              ...
              <table class="table table-bordered">
                ...
                <tbody id="approved_record_teach">
    ...
    function approved_record_view(){
      $.ajax({
        ...
        success: function(data){
          ...
          $('#approved_record_teach').html(data);
          $('#approved_record_teach .deleteRecord').addClass('hide');
        }
      });              
    }
