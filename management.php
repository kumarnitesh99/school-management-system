    ...
    <div class="container my-2 py-3 dashboard-content">
        ...
        <div class="col-md-12">
            <div class="card-header">
                <ul class="navbar-nav ul1">
                  <li>
                    <?php
                      if($cpage == "management.php"){
                        echo "<span class='nav-link'><i class='fa fa-desktop'></i> <a href='index.php'> Dashboard</a>/  <i class='fa fa-user'></i> Management </span>";
                      }
                    ?>
                  </li>
                </ul>
      ...
      <div class="row my-2">
        <div class="col-md-4">
          ...
          <div class="card action-management-card">
            <a href=""class="card-body" data-bs-toggle="modal" data-bs-target="#managementAdd" id="close
            ">
                Add+
            </a>
            <!-- Modal -->
            <div class="modal fade" id="managementAdd" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <form name="addForm" id="addForm">
                      <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">New Management Add</h5>
                        ...
                        <div class="col-lg-12 mb-2">
                            <select class="form-select" id='select' name="select">
                                ...
                                <?php
                                    ...
                                    $name = $result[2]['type_name'];
                                    $value = $result[2]['type_value'];
                      ...
                      <div class="modal-footer">
                        <input type="submit" value="Add" class="btn btn-primary" id="addbtn">
        ...
        <div class="col-md-4">
          <div class="card pending-management-card">
            <a class="card-body" href="pending-management.php">
              Pending
            </a>
          </div>                   
        </div>
        <div class="col-md-4">
          <div class="card rejected-management-card">
            <a class="card-body" href="rejected-management.php">
              Rejected
            </a>
          </div>                   
        </div>
      ...
      <div class="row"> 
        <div class="col-md-12 updateColumn">
          <p href=""class="update-management-card" data-bs-toggle="modal" data-bs-target="#updateRecord"></p>
          
          <p href=""class="delete-management-card" data-bs-toggle="modal" data-bs-target="#deleteRecordModal" id="close"></p>   
  ...
  $(document).ready(function(){
    ...
    $(document).on('click','.updateRecord',function(){
        ...
        $.ajax({
            ...
            method: "POST",
            data: {'email':email, 'type_user': 3},
            success: function(data){
              $('.updateColumn').append(data);
              $('.update-management-card').trigger('click');
            }
        });
    });
    // Update Record
    ...
    $(document).on('click','.deleteRecord',function(){
      ...
      $('.delete-management-card').trigger('click');
