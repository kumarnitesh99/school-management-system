        ...
        <div class="col-md-12">
            <div class="card-header">
                <ul class="navbar-nav ul1">
                  <li>
                    <?php
                      if($cpage == "rejected-student.php"){
                        echo "<span class='nav-link'><i class='fa fa-desktop'></i> <a href='index.php'> Dashboard</a>/  <i class='fa fa-user'></i> <a href='student.php'> Student</a> /<i class='fa fa-users'> Rejected</i> </span>";
                      }
                    ?>
                  </li>
                </ul>
